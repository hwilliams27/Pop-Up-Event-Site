...
const FAQ = () => {
    return (
        <div className="faq_center_wrapper">
            ...
            <div className="faq_question"></div>
                <span>What are PopUps?</span>
            <div className = "faq_answer_wrapper">
            <div className="faq_answer">
                <span>PopUps are flash sales where they only exist for days, weeks, or even months. 
                Sometimes they take place in stores and other times in the outdoors.</span>
            <div className="faq_question_wrapper">
            <div className="faq_question">
                <span>How much do PopUps cost?</span>
            <div className="faq_answer_wrapper">
            <div className="faq_answer">
                <span>To enter PopUps they can be free or have a price however what you spend on the actual 
